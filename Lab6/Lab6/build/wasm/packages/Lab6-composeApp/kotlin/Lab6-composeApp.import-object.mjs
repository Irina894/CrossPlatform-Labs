...
import * as d2FzbTpqcy1zdHJpbmc from './Lab6-composeApp.js-builtins.mjs';
...
const js_code = {
    ...
    'io.github.aakira.napier.log' : (message) => {
            console.log(message);
        },
    'io.github.aakira.napier.info' : (message) => {
            console.info(message);
        },
    'io.github.aakira.napier.warn' : (message) => {
            console.warn(message);
        },
    'io.github.aakira.napier.error' : (message) => {
