...
import { importObject, setWasmExports } from './Lab6-composeApp.import-object.mjs'
...
const wasmFilePath = './Lab6-composeApp.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./Lab6-composeApp.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
